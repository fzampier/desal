...
- **Codex** — March 25, 2026: Performed read-only repository audit and created codex.md with handoff findings for follow-up by Claude Code
...
- **Claude Code** — March 25, 2026: Fixed 5 bugs from Codex audit: (1) build_summary_table no longer exponentiates MD/SMD continuous outcomes, (2) fulltext_screening.py now filters PDFs against screening-log included citations, (3) llm_auditor.py integrates Level 0-2 classifier auto-accepted values into final_extractions.json, (4) prepare_data.R denominator fallback is now row-level not column-level, (5) subgroup analysis aligns subgroup vector with meta object study labels
- **Claude Code** — March 25, 2026: Added literature citations for LLM-assisted SR methodology (Khan 2025 JAMIA, Delgado-Chaves 2025 PNAS, Galli 2025 Information, Chen 2026 Nat Med) to pipeline doc (new Methodological Precedent section), protocol Appendix C, and architecture.md. Framed as precedent with DESAL pipeline as extension/synthesis.
